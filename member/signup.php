			...
			<div class="col-md-4 col-sm-12 col-xs-12 col-md-offset-4">
				<form class="frm_student_sign">
					...
					<div class="form-group">
						...
						<input type="text" name="s_fname" class="form-control" required autocomplete="off" style="text-transform: capitalize;">
					</div>
					<div class="form-group">
						<label>Last Name</label>
						<input type="text" name="s_lname" class="form-control" required autocomplete="off" style="text-transform: capitalize;">
					</div>
					<div class="form-group">
						<label>Sex</label>
